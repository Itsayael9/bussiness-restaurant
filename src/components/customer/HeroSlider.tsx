...
const slides = (sliderData as Slide[]).filter((s) => s.active).sort((a, b) => a.order - b.order);
  ...
  return (
    <section className="relative w-full overflow-hidden bg-ink aspect-[16/9] md:aspect-[21/9] max-h-[80vh]">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
        ...
        >
          <p className="text-gold text-xs sm:text-sm tracking-[0.4em] uppercase mb-3 sm:mb-5 font-medium hero-text-shadow">
            {t("hero.subtitle")}
          </p>
          <h1 className="font-display text-gold text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight hero-text-shadow leading-tight">
            {t("hero.title")}
          </h1>
        </motion.div>
      </div>
